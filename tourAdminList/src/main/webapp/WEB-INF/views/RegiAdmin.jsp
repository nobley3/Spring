...
<script src="${path}/resources/js/adminJoin.js"></script>
...
<body>
	...
	<section>
		<div class="joinwrap">
			<!-- 이미지 -->
			<div class="joinimg">
				<img class="img1" alt="joinimg" src="${path}/resources/img/backgroundcolor2.jpg"
					alt="joinimg">
			
			<h2>새로운 시작, 새로운 도전!<br>
			한국관광공사의 가족이 되신 걸 환영합니다.</h2>
				<img alt="" class="img2" src="${path}/resources/img/hello.png">
			</div>
			<div class="formwrap">
			<b>Add Member</b>
