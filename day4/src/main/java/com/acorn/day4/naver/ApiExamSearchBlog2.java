...
//		 String (json구조를 가진) -> JSON변환

			
		JSONObject rjson = new JSONObject(result); // json으로 바꿔줌
	...
	public String getNaverAPI() {
		...
		String clientId = "wzGJHYpjIuoG4ALp5Cpg"; // 애플리케이션 클라이언트 아이디
		String clientSecret = "wmFXlJhR0L"; // 애플리케이션 클라이언트 시크릿
